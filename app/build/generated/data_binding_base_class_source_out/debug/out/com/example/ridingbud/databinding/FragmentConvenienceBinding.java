...
public final class FragmentConvenienceBinding implements ViewBinding {
  ...
  private FragmentConvenienceBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static FragmentConvenienceBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentConvenienceBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_convenience, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentConvenienceBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentConvenienceBinding((ConstraintLayout) rootView, btnCurrentLocation,
